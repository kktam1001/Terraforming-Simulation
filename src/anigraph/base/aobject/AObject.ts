...
class AStateCallbackSwitch extends ACallbackSwitch {
  /*
  State callback switch corresponding to a callback that gets called any time any of an object's state gets changed.
   */
...
export class AObject extends AHandlesEvents{
  ...
  /**
   * Adds a callback to be called whenever *any* of the object's state changes. To listen to just one state key, use `addStateKeyListener` instead.
