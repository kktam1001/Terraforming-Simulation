 ...
 */
import {App3DSceneModel} from "./App3DSceneModel";
 ...
 */
export abstract class App3DSceneController extends ABasicSceneController{

    abstract onAnimationFrameCallback(context: AGLContext):void;
    abstract initInteractions() :void;

    get model():App3DSceneModel{
        return this._model as App3DSceneModel;
    }
